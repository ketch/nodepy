...
EXAMPLES:
    ...
    sage: from rooted_trees import *
    sage: tree=RootedTree('{T^2{T{T}}{T}}')
    sage: tree.plot()
    sage: tree.order()
    9
    sage: tree.density()
    ...
    sage: tree2=RootedTree('{T^2{T}{T{T}}}')
    sage: tree2==tree
    True
...
#=====================================================
    ...
    def Emap(self,a=1):
        ...
        """
        return a**self.order()/Integer(self.density())
    ...
    def factor(self):
        """ 
            ...
            EXAMPLES:
                sage: tree=RootedTree('{T^2{T}}')
                sage: t,u=tree.factor()
                sage: t
                '{T{T}}'
                sage: u
                'T'
...
#=====================================================
  """ 
    ...
    EXAMPLES:
        ...
        sage:     forest=recursive_trees(i)
        sage:     print len(forest)
        1
        1
        2
        4
...
def Emap(tree,a=1):
    ...
    in time.
    """
    return a**tree.order()/Integer(tree.density())

def Emap_str(tree,a=1):
    return str(a**tree.order()/Integer(tree.density()))
